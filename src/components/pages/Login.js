                ...
                <div className="content">
                    ...
                    <div className="row">
                        ...
                        <div className="card">
                            ...
                            <a href="https://login-iac.auth.ap-southeast-1.amazoncognito.com/login?client_id=4omij3pn3iksj75f8ac14p6la9&response_type=code&scope=aws.cognito.signin.user.admin+email+openid+phone+profile&redirect_uri=https://simulasi-iac.netlify.app//home" className="btn btn-primary">Login</a>
                            </div>
                        </div>
                        </div>
                        {/* /.col-md-6 */}
